...
public class NullCoalesceTests
{
	...
	[InlineData("1", 1)]
	[InlineData("", null)]
	public async Task Parse_GoodValues_Succeeds(string parameters, object? expectedValue)
	{
	...
	public async Task Parse_ComplexInput_Succeeds(object? a, object? b, object? c, string? expectedValue)
	{
