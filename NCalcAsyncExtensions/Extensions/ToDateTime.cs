...
internal static class ToDateTime
{
	...
	{
		var argument1 = functionArgs.Parameters.Length >= 1 ? await functionArgs.Parameters[0].EvaluateSafelyAsync() : null;
		var argument2 = functionArgs.Parameters.Length >= 2 ? await functionArgs.Parameters[1].EvaluateSafelyAsync() : null;
		var argument3 = functionArgs.Parameters.Length >= 3 ? await functionArgs.Parameters[2].EvaluateSafelyAsync() : null;
